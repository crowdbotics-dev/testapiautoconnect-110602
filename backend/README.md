...
## Project Structure
    ...
    ├── testapiautoconnect_110602  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_110602`
...
2. Clone this repo and `cd testapiautoconnect_110602`
